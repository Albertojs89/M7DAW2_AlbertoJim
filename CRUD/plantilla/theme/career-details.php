      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-7 order-2 order-lg-1">
            <h3 class="mb-3">Jobs Description</h3>
            <p class="mb-5">
            ...
            <h5 class="">Responsibilities:</h5>
            <p class="pb-3">
              Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
              officia deserunt mollit anim id est laborum sed ut perspiciatis
              unde.
            </p>
            <ul class="list-styled style-check mb-5">
              <li class="mb-3">
                Talking with clients or account managers to discuss the business
              ...
              <li class="mb-3">
                Thinking creatively to produce new ideas, concepts and
                developing interactive design;
              </li>
              <li class="mb-3">
                Presenting finalized ideas and concepts to clients or account
                managers;
              </li>
            </ul>
          ...
          <div class="col-lg-4 order-1 order-lg-2 mb-5 mb-lg-0">
            <div class="p-5 rounded border sticky-top top-100">
              <h5 class="text-dark">Job Details</h5>
              <p class="border-bottom pb-4">
                Lorem ipsum dolor sit amet consectetur elit sed do eiusmod
                tempor
              </p>
              <ul class="list-unstyled border-bottom mb-4">
                <li class="mb-4">
                  <h6 class="text-secondary">Location</h6>
                  <p>London, United Kingdom</p>
                </li>
                <li class="mb-4">
                  <h6 class="text-secondary">Job Type</h6>
                  <p>Full time</p>
                </li>
                <li class="mb-4">
                  <h6 class="text-secondary">Date Posted</h6>
                  <p>3 days ago</p>
                </li>
              </ul>
