            ...
            <div class="p-5 mb-4">
              <div class="media border-bottom py-4">
                <img
                  ...
                  class="img-fluid align-self-start mr-3"
                  alt=""
                />
                <div class="media-body">
                  ...
                  <a href="#" class="btn btn-transparent py-1 px-2"
                    ><i class="ti-share-alt"></i> Reply</a
                  >
                  <p>
                    Ne erat velit invidunt his. Eum in dicta veniam interesset,
                    harum fuisset te nam ea cu lupta definitionem.
                  </p>
                  <div class="media my-5">
                    ...
                    <div class="media-body">
                      ...
                      <p>
                        ...
                        interesset, harum fuisset te nam ea cu lupta
                        definitionem.
                      </p>
                    </div>
                  </div>
            ...
            <form action="#" class="row">
              <div class="col-12">
                <textarea
                  ...
                  id="comment"
                  placeholder="Message"
                  class="form-control mb-4 border"
                ></textarea>
              </div>
              <div class="col-md-5">
                <input
                  ...
                  name="name"
                  id="name"
                  class="form-control mb-4 mb-lg-0 border"
                  placeholder="Name"
                />
              </div>
              <div class="col-md-5">
