...
<head>
  ...
  <title>Administrar Análisis - BITEPIXE</title>
...
<body>
<div class="admin-analisis-container">
  <h2 class="text-center mb-4">Gestión de Análisis</h2>

  <div class="text-center mb-4">
    <a href="añadirAnalisis.php" class="btn-add-analisis"><i class="fas fa-plus"></i> Añadir Análisis</a>
  </div>

  <div class="admin-analisis-grid">
    <?php foreach ($analisis as $item): ?>
      <div class="analisis-card">
        <img src="../images/<?= htmlspecialchars($item['imagen']) ?>" alt="Imagen Análisis">
        <h4><?= htmlspecialchars($item['titulo']) ?></h4>
        <div class="card-actions">
          <a href="editarAnalisis.php?id=<?= $item['id'] ?>" class="btn-edit"><i class="fas fa-pen"></i> Editar</a>
          <a href="eliminarAnalisis.php?id=<?= $item['id'] ?>" class="btn-delete"><i class="fas fa-trash"></i></a>
        </div>
      </div>
    <?php endforeach; ?>
  </div>
